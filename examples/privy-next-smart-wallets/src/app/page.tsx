...
import EVMSmartWalletActions from "@/components/sections/evm-smart-wallet-actions";
        ...
        <section className="w-full flex flex-row justify-center items-center h-[calc(100vh-60px)] relative">
          ...
          <div className="z-10 flex flex-col items-center justify-center w-full h-full">
            ...
            <div className="text-center text-white text-xl font-normal leading-loose mt-8">
              Get started developing with Privy and smart wallet integration
              using our Next.js starter repo
            </div>
            <button
