...
```bash
mkdir -p privy-next-farcaster && curl -L https://github.com/privy-io/privy-examples/archive/main.tar.gz | tar -xz --strip=3 -C privy-next-farcaster examples-main/examples/privy-next-farcaster && cd privy-next-farcaster
```
