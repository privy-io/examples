              ...
              <div className="hidden sm:ml-6 sm:block">
                <div className="flex items-center">
                  ...
                  <Menu as="div" className="relative ml-3">
                    <div className="flex items-center rounded-full bg-gray-800 hover:cursor-pointer hover:outline-none hover:ring-2 hover:ring-white hover:ring-offset-2 hover:ring-offset-gray-800">
